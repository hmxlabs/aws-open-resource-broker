...
from orb.domain.base.ports.storage_reader_port import StorageReaderPort
from orb.domain.base.ports.storage_writer_port import StorageWriterPort
from orb.infrastructure.storage.base.strategy import StorageStrategy
