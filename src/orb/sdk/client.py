...
class ORBClient:
    ...
    # Template operations
    async def get_template(self, *, template_id: str, **kwargs: Any) -> Any: pass
    async def list_templates(self, *, active_only: bool = False, **kwargs: Any) -> Any: pass
    async def validate_template(self, *, template_id: str, **kwargs: Any) -> Any: pass
    async def get_configuration(self, **kwargs: Any) -> Any: pass
    async def create_template(self, *, template_id: str, **kwargs: Any) -> Any: pass
    async def update_template(self, *, template_id: str, **kwargs: Any) -> Any: pass
    async def delete_template(self, *, template_id: str, **kwargs: Any) -> Any: pass
    async def refresh_templates(self, **kwargs: Any) -> Any: pass

    # Request operations
    async def get_request(self, *, request_id: str, **kwargs: Any) -> Any: pass
    async def list_requests(self, **kwargs: Any) -> Any: pass
    async def list_return_requests(self, **kwargs: Any) -> Any: pass
    async def list_active_requests(self, **kwargs: Any) -> Any: pass
    async def get_request_summary(self, *, request_id: str, **kwargs: Any) -> Any: pass
    async def create_request(self, *, template_id: str, count: int = 1, **kwargs: Any) -> Any: pass
    async def create_return_request(self, *, machine_ids: list[str], **kwargs: Any) -> Any: pass
    async def update_request_status(self, *, request_id: str, **kwargs: Any) -> Any: pass
    async def cancel_request(self, *, request_id: str, **kwargs: Any) -> Any: pass
    async def complete_request(self, *, request_id: str, **kwargs: Any) -> Any: pass
    async def sync_request(self, *, request_id: str, **kwargs: Any) -> Any: pass
    async def populate_machine_ids(self, *, request_id: str, **kwargs: Any) -> Any: pass

    # Machine operations
    async def get_machine(self, *, machine_id: str, **kwargs: Any) -> Any: pass
    async def list_machines(self, **kwargs: Any) -> Any: pass
    async def get_active_machine_count(self, **kwargs: Any) -> Any: pass
    async def get_machine_health(self, **kwargs: Any) -> Any: pass
    async def update_machine_status(self, *, machine_id: str, **kwargs: Any) -> Any: pass
    async def convert_machine_status(self, **kwargs: Any) -> Any: pass
    async def convert_batch_machine_status(self, **kwargs: Any) -> Any: pass
    async def cleanup_machine_resources(self, **kwargs: Any) -> Any: pass
    async def register_machine(self, **kwargs: Any) -> Any: pass
    async def deregister_machine(self, *, machine_id: str, **kwargs: Any) -> Any: pass

    # Provider operations
    async def get_provider_health(self, **kwargs: Any) -> Any: pass
    async def list_available_providers(self, **kwargs: Any) -> Any: pass
    async def get_provider_capabilities(self, **kwargs: Any) -> Any: pass
    async def get_provider_metrics(self, **kwargs: Any) -> Any: pass
    async def get_provider_strategy_config(self, **kwargs: Any) -> Any: pass
    async def execute_provider_operation(self, **kwargs: Any) -> Any: pass
    async def register_provider_strategy(self, **kwargs: Any) -> Any: pass
    async def update_provider_health(self, **kwargs: Any) -> Any: pass

    # Bulk operations
    async def get_multiple_requests(self, *, request_ids: list[str], **kwargs: Any) -> Any: pass
    async def get_multiple_templates(self, *, template_ids: list[str], **kwargs: Any) -> Any: pass
    async def get_multiple_machines(self, *, machine_ids: list[str], **kwargs: Any) -> Any: pass

    # Cleanup operations
    async def list_cleanable_requests(self, **kwargs: Any) -> Any: pass
    async def list_cleanable_resources(self, **kwargs: Any) -> Any: pass
    async def cleanup_old_requests(self, **kwargs: Any) -> Any: pass
    async def cleanup_all_resources(self, **kwargs: Any) -> Any: pass

    # Storage operations
    async def list_storage_strategies(self, **kwargs: Any) -> Any: pass
    async def get_storage_health(self, **kwargs: Any) -> Any: pass
    async def get_storage_metrics(self, **kwargs: Any) -> Any: pass

    # Scheduler operations
    async def list_scheduler_strategies(self, **kwargs: Any) -> Any: pass
    async def get_scheduler_configuration(self, **kwargs: Any) -> Any: pass
    async def validate_scheduler_configuration(self, **kwargs: Any) -> Any: pass

    # System / config operations
    async def get_configuration_section(self, *, section: str, **kwargs: Any) -> Any: pass
    async def get_provider_config(self, **kwargs: Any) -> Any: pass
    async def validate_provider_config(self, **kwargs: Any) -> Any: pass
    async def get_system_status(self, **kwargs: Any) -> Any: pass
    async def validate_storage(self, **kwargs: Any) -> Any: pass
    async def validate_mcp(self, **kwargs: Any) -> Any: pass
    async def validate_provider_state(self, **kwargs: Any) -> Any: pass
    async def reload_provider_config(self, **kwargs: Any) -> Any: pass
    async def set_configuration(self, **kwargs: Any) -> Any: pass
