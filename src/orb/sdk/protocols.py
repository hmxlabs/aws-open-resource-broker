...
class ORBClientProtocol(Protocol):
    ...
    async def list_templates(self, *, active_only: bool = False, **kwargs: Any) -> list[dict[str, Any]]: ...
    ...
    async def create_request(self, *, template_id: str, count: int = 1, **kwargs: Any) -> dict[str, Any]: ...
    async def create_return_request(self, *, machine_ids: list[str], **kwargs: Any) -> dict[str, Any]: ...
    ...
    # --- Bulk operations ---
    async def get_multiple_requests(self, *, request_ids: list[str], **kwargs: Any) -> list[dict[str, Any]]: ...
    async def get_multiple_templates(self, *, template_ids: list[str], **kwargs: Any) -> list[dict[str, Any]]: ...
    async def get_multiple_machines(self, *, machine_ids: list[str], **kwargs: Any) -> list[dict[str, Any]]: ...
