...
from orb.k8s_legacy.cli.hf import run as hostfactory
...
@mock.patch("orb.k8s_legacy.k8sutils.get_namespace")
@mock.patch("orb.k8s_legacy.k8sutils.get_kubernetes_client", return_value=MagicMock())
@mock.patch("orb.k8s_legacy.k8sutils.load_k8s_config", return_value=None)
@mock.patch("orb.k8s_legacy.hfcron.CleanupPodsTask._delete_k8s_pod")
@mock.patch("orb.k8s_legacy.hfcron.CleanupPodsTask._is_timeout_reached")
@mock.patch("orb.k8s_legacy.hfcron.RefreshPodsTask")
@mock.patch("orb.k8s_legacy.hfcron.RefreshNodesTask")
class TestHFCron(TestCase):
