...
from orb.k8s_legacy.app.hfutilsapp import Settings
from orb.k8s_legacy.app.hfutilsapp import create_app
...
def test_push_eventsdb_creates_event_file(client, temp_workdir, monkeypatch):
    ...
    monkeypatch.setattr(
        "orb.k8s_legacy.app.hfutilsapp._push_backup_event", mock_push_backup_event
    )
