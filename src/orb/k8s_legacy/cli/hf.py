...
from orb.k8s_legacy import handle_exceptions
from orb.k8s_legacy import api as hfapi
from orb.k8s_legacy import cli
from orb.k8s_legacy import hfcron
from orb.k8s_legacy import k8sutils
from orb.k8s_legacy.cli import context
from orb.k8s_legacy.cli import log_handler
from orb.k8s_legacy.impl.watchers import events as event_watcher
from orb.k8s_legacy.impl.watchers import handlers
from orb.k8s_legacy.impl.watchers import kube_watcher
from orb.k8s_legacy.impl.watchers import node_watcher
from orb.k8s_legacy.impl.watchers import pod_watcher
from orb.k8s_legacy.impl.watchers import request

ON_EXCEPTIONS = handle_exceptions(
    [
        (
...
def run(proxy, log_level, log_file, workdir, confdir, request_id) -> None:
    ...
    if not request_id:
        context.GLOBAL.request_id = generate_short_uuid()
    else:
