...
def register_aws_provider_with_di(provider_instance, container) -> bool:
    ...
    try:
        ...
        def aws_strategy_factory():
            ...
            # TODO: This does not match the registry contract used by create_strategy_from_instance(),
            #  which invokes strategy factories as factory(config), which seems wrong?
