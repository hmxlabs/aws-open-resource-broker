...
class BaseTemplateContract:
    ...
    def test_templates_have_required_fields(self, template_provider):
        ...
        for tpl in templates:
            assert hasattr(tpl, "template_id") or (isinstance(tpl, dict) and "template_id" in tpl), \
            ...
            assert hasattr(tpl, "provider_api") or (isinstance(tpl, dict) and "provider_api" in tpl), \
                f"template missing provider_api: {tpl}"

    @pytest.mark.provider_contract
    def test_validate_template_accepts_valid_template(self, template_provider, valid_template_for_validation):
    ...
    @pytest.mark.provider_contract
    def test_validate_template_rejects_invalid_template(self, template_provider, invalid_template_for_validation):
