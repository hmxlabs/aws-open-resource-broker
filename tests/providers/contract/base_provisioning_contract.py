...
class BaseProvisioningContract:
    ...
    def test_acquire_returns_success(self, provider_under_test, valid_provision_request, valid_template):
    ...
    @pytest.mark.provider_contract
    def test_acquire_returns_resource_ids(self, provider_under_test, valid_provision_request, valid_template):
    ...
    @pytest.mark.provider_contract
    def test_acquire_respects_requested_count(self, provider_under_test, valid_provision_request, valid_template):
        """acquire_hosts must return at least one resource ID for any positive count."""
        result = provider_under_test.acquire_hosts(valid_provision_request, valid_template)
        assert len(result.get("resource_ids", [])) >= 1

    @pytest.mark.provider_contract
    def test_acquire_resource_ids_are_stable(self, provider_under_test, valid_provision_request, valid_template):
    ...
    @pytest.mark.provider_contract
    def test_release_does_not_raise(self, provider_under_test, valid_provision_request, valid_template):
    ...
    @pytest.mark.provider_contract
    def test_release_is_idempotent(self, provider_under_test, valid_provision_request, valid_template):
