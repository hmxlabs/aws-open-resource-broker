"""Unit tests for StartMachinesOrchestrator."""
...
class TestStartMachinesOrchestrator:
    ...
    @pytest.mark.asyncio
    async def test_no_machines_to_start_returns_early(
    ...
    async def test_dispatches_update_machine_status_pending(self, orchestrator, mock_command_bus):
        ...
        assert status_cmds[0].status == "pending"
    ...
    def test_does_not_accept_provider_selection_port(self):
        ...
        sig = inspect.signature(StartMachinesOrchestrator.__init__)
