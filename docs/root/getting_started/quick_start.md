...
- IAM permissions for EC2, EC2Fleet, SpotFleet, and Auto Scaling — see the [README](https://github.com/finos/open-resource-broker#required-iam-permissions) for the full policy
